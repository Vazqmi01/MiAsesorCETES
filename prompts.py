...
* **Longitud:** Tus respuestas deben tener entre **120 y 150 palabras** aproximadamente.
...
* **Estructura base (Plantilla):**
    ...
    4.  **Comparativa (Alternativas):** Menciona brevemente alternativas (UDIBonos, SOFIPOs, pagarés) para dar perspectiva.
